...
byte aux_buttons[1][NUMAUXPINS] ={{18,19}};
...
byte auxRowPins[NUMAUXPINS] = {12, 13}; //change "?" to the pins the rows of your button matrix are connected to
byte auxColPins[1] = {11};
...
Keypad aux_buttbx = Keypad(makeKeymap(aux_buttons), auxRowPins, auxColPins, NUMROWS, NUMCOLS);
